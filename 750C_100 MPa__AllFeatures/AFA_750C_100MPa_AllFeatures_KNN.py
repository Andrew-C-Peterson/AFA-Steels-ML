...
for i in range(0, len(labels_ranked)):
    model_rkf_ranked = neighbors.KNeighborsRegressor(n_neighbors = 2)
...
plt.ylabel('Accuracy')
plt.title('Accuracy vs # of features for KNN (RT)')
plt.legend()
plt.ylim([-100,100])
plt.figure()
...
plt.title('Actual vs Predicted Values for KNN (RT)')
...
for i in range(0, len(labels_ranked)):
    model_rkf_ranked_2 = neighbors.KNeighborsRegressor(n_neighbors = 2)
...
plt.xlabel('# of features')
plt.ylabel('Accuracy')
plt.title('Accuracy vs # of features for KNN (LMP)')
plt.legend()
plt.ylim([-100,100])
plt.figure()    
...
plt.title('Actual vs Predicted Values for KNN (LMP)')
